...
**소스에서 빌드하는 것이 권장 설치 방법입니다.** 편의를 위해
[0.0.1 미리보기 빌드](https://github.com/wawds123/sftp-manager/releases/tag/v0.0.1)(유니버설, 8.9MB)를
올려 두긴 했지만, 공증이 아닌 ad-hoc 서명이라 내려받으면 macOS가 격리해서 손으로 풀어줘야 합니다
(→ [macOS 주의사항](#macos)). 직접 빌드하면 그 과정이 아예 없습니다.
